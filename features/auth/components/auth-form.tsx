    ...
    >
      <FieldGroup>
        <Controller
          ...
          render={({ field }) => (
            <Field className="p-0.5 rounded-lg bg-muted">
              <div className="flex gap-2 sm:gap-3 items-center px-4 py-2 bg-background rounded-lg">
                <IconMail size={32} />
                <Separator orientation="vertical" />

                <div className="flex-1 flex flex-col gap-1 dark:bg-me">
                  <FieldLabel
                    htmlFor="email"
